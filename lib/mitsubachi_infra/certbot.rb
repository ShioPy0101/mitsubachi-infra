...
module MitsubachiInfra
  class Certbot
    ...
    def enable(staging: false)
      ...
      args = ["certbot", "certonly", "--webroot", "-w", ACME_ROOT, "-d", host, "--email", email, "--agree-tos", "--non-interactive"]
      ...
      raise Error, "certificate files are missing after certbot" unless @runner.dry_run || (File.exist?(cert) && File.exist?(key))
